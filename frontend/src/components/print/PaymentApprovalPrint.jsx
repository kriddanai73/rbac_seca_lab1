...
const PaymentApprovalPrint = ({ formData = {} }) => {
  ...
  return (
    ...
    >
      ...
      <div style={{ marginBottom: '12px' }}>
        ...
        <div style={{ display: 'flex', alignItems: 'center', gap: '18px', flexWrap: 'wrap', marginBottom: '8px' }}>
          ...
          {['กรรมการผู้จัดการ', 'ผู้อำนวยการ', 'ผู้จัดการ'].map((opt) => (
            <label key={opt} style={{ display: 'inline-flex', alignItems: 'center', gap: '4px' }}>
              <input type="radio" checked={formData.to === opt} readOnly />
              <span>{opt}</span>
            </label>
          ))}
        </div>

        <div style={{ display: 'flex', alignItems: 'center', gap: '16px', flexWrap: 'wrap', marginBottom: '8px', paddingLeft: '90px' }}>
          <span>โปรดพิจารณาอนุมัติเบิกจ่าย เพื่อใช้ในงาน :-</span>

          <label style={{ display: 'inline-flex', alignItems: 'center', gap: '4px' }}>
            <input type="radio" checked={formData.location === 'สำนักงานใหญ่'} readOnly />
            <span>สำนักงานใหญ่</span>
          </label>

          <label style={{ display: 'inline-flex', alignItems: 'center', gap: '4px' }}>
            <input type="radio" checked={formData.location === 'สาขา'} readOnly />
            <span>สาขา</span>
        ...
        <div style={{ display: 'flex', alignItems: 'center', gap: '16px', flexWrap: 'wrap', marginBottom: '8px', paddingLeft: '35px' }}>
          {['บริหาร', 'ธุรการทั่วไป', 'บัญชีการเงิน', 'ขาย', 'จัดซื้อ', 'วิศวกรรม', 'ซ่อมบำรุง'].map((type) => (
            <label key={type} style={{ display: 'inline-flex', alignItems: 'center', gap: '4px' }}>
              <input type="radio" checked={formData.departmentType === type} readOnly />
              <span>{type}</span>
            </label>
          ))}
        </div>

        <div style={{ display: 'flex', alignItems: 'center', gap: '16px', flexWrap: 'wrap', marginBottom: '12px', paddingLeft: '35px' }}>
...
>
            ...
            <td style={{ border: '1px solid #000' }}></td>
            <td style={{ border: '1px solid #000' }}></td>
            <td style={{ border: '1px solid #000', textAlign: 'right', padding: '6px 8px' }}>{formData.depositAmount}</td>
          </tr>

          <tr>
            <td style={{ border: '1px solid #000' }}></td>
            <td style={{ border: '1px solid #000', textAlign: 'center', fontWeight: 'bold', padding: '6px 8px' }}>คงเหลือ</td>
            <td style={{ border: '1px solid #000' }}></td>
            <td style={{ border: '1px solid #000' }}></td>
            <td style={{ border: '1px solid #000', textAlign: 'right', padding: '6px 8px' }}>{formData.balance}</td>
          </tr>

          <tr>
            <td style={{ border: '1px solid #000' }}></td>
            <td style={{ border: '1px solid #000', textAlign: 'center', fontWeight: 'bold', padding: '6px 8px' }}>บวก ภาษีมูลค่าเพิ่ม 7%</td>
            <td style={{ border: '1px solid #000' }}></td>
            <td style={{ border: '1px solid #000' }}></td>
            <td style={{ border: '1px solid #000', textAlign: 'right', padding: '6px 8px' }}>{formData.vatAmount}</td>
          </tr>

          <tr>
            <td style={{ border: '1px solid #000' }}></td>
            <td style={{ border: '1px solid #000', textAlign: 'center', fontWeight: 'bold', padding: '6px 8px' }}>รวมเงินทั้งสิ้น</td>
            <td style={{ border: '1px solid #000' }}></td>
            <td style={{ border: '1px solid #000' }}></td>
            <td style={{ border: '1px solid #000', textAlign: 'right', padding: '6px 8px' }}>{formData.totalAmount}</td>
          </tr>
        </tbody>
      </table>
      ...
      <div style={{ display: 'flex', justifyContent: 'center', marginTop: '10px', marginBottom: '18px' }}>
        <div style={{ display: 'flex', alignItems: 'flex-end', width: '520px', gap: '4px' }}>
          ...
          <span style={{ ...dottedStyle, width: '50px', textAlign: 'center' }}>{formData.withholdingTaxPercent}</span>
          <span>% เป็นจำนวนเงิน</span>
          <span style={{ ...dottedStyle, width: '160px', textAlign: 'right' }}>{formData.withholdingTaxAmount}</span>
          <span>บาท</span>
        </div>
      </div>
      ...
      >
        <tbody>
          ...
          <tr>
            <td style={{ border: '1px solid #000', borderBottom: 'none', borderLeft: 'none', padding: '10px 5px', verticalAlign: 'top' }}>
            ...
            <td style={{ border: '1px solid #000', borderBottom: 'none', padding: '10px 5px', verticalAlign: 'top' }}>
            ...
            <td style={{ border: '1px solid #000', borderBottom: 'none', borderRight: 'none', padding: '10px 5px', verticalAlign: 'top' }}>
              <div style={{ textAlign: 'center', fontWeight: 'bold', minHeight: '40px' }}>
                ผู้อนุมัติ
